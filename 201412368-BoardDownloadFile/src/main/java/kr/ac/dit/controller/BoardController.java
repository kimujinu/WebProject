...
public class BoardController {
	...
	public String deleteGET(@RequestParam("no") int no) throws Exception {
	 ...
	 public ResponseEntity<byte[]> download(@RequestParam("fileName") String fileName) throws Exception {
	  ...
	  InputStream inputStream = new FileInputStream("c:/upload/"+fileName);
	  return new ResponseEntity<byte[]>(IOUtils.toByteArray(inputStream),httpHeaders, HttpStatus.CREATED);
	 }
